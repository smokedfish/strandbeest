...
public class RoundedHelper {
	...
	public RoundedHelper(double thickness) {
		this.thickness = thickness;
	}

	public void roundedTriangle(Graphic graphic, Color color, Point p1, Point p2, Point p3) {
		...
		roundedCorner(graphic, color, p1, p1a13, p1a12);
		graphic.line(color, p1a12, p2a12);
		roundedCorner(graphic, color, p2, p2a12, p2a23);
		graphic.line(color, p2a23, p3a23);
		roundedCorner(graphic, color, p3, p3a23, p3a13);
		graphic.line(color, p3a13, p1a13);
	}

	public void roundedRectangle(Graphic graphic, Color color, Point p1, Point p2) {
	...
	public void roundedCorner(Graphic graphic, Color color, Point center, Point start, Point end) {
